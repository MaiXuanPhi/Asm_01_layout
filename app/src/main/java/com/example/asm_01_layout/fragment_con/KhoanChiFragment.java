...
public class KhoanChiFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.khoanchi_recyclerview); //sua
        floatingActionButton = view.findViewById(R.id.khoanchi_floatingActionButton); //sua
    ...
    public void cap_nhat() {
        ...
        list = giaoDichDAO.xemGD2("chi");
        Recyclerview adapter = new Recyclerview(getContext(), list, 1, KhoanChiFragment.this);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapter);
    }

    public void xemGD(int position){
        diaLog(1, position, "Xem khoản chi");
    }

    public void suaGD(int position){
        diaLog(2, position, "Sửa khoản chi");
    }
    ...
    public void diaLog(int loaidialog, int position, String tenchucnang){
        ...
        list_sp = phanLoaiDAO.xemPL2("chi");
