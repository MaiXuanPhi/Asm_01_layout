...
import com.example.asm_01_layout.viewpager.ChiViewPager;
...
public class ChiFragment extends Fragment {
    ...
    public void onViewCreated(View view,Bundle savedInstanceState) {
        ...
        tabLayout = view.findViewById(R.id.chi_tablayout);
        viewPager = view.findViewById(R.id.chi_viewpager);

        ChiViewPager adapter = new ChiViewPager(getActivity().getSupportFragmentManager(),2);
